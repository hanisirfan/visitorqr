        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            <div class="container w-75 text-center">
                ...
                <div class="row d-flex gap-4 mt-5 justify-content-center align-items-center">
                    @if (Route::has('login'))
                            @auth
                                <p class="fs-3">Welcome, {{ ucfirst(Auth::user()->name) }}!</p>
                                <a href="{{ url('/home') }}" class="col-lg-2 col-5 fs-5  btn btn-dark btn fw-bold"><i class="bi bi-house"></i> Home</a>
                            @else
                                <a href="{{ route('login') }}" class="col-lg-2 col-5 fs-5 btn btn-dark btn fw-bold"><i class="bi bi-door-open"></i> Log in</a>

                                <!-- Only admins can register new users. -->
                                {{-- @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="col-lg-2 col-5 fs-5 btn btn-dark btn fw-bold">Register</a>
                                @endif --}}
                            @endauth
                    @endif
                </div>
